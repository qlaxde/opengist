...
func (s *Server) registerRoutes() {
...

	{
		...
		sB := r.SubGroup("/admin-panel")
		{
			...
			sB.GET("/site-routes", admin.AdminSiteRoutes)
			sB.POST("/site-routes", admin.AdminSiteRoutesCreate)
			sB.POST("/site-routes/:id/edit", admin.AdminSiteRoutesUpdate)
			sB.POST("/site-routes/:id/delete", admin.AdminSiteRoutesDelete)
